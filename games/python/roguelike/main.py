from functions import player, bullet, ammo, target, necromancer, dictcreator, dictcreatorwbullets, dictcreator3, dictcreatorwbullets3, dictcreator6, dictcreatorwbullets6, runshop, printdict, interface, threatconlvl
import time
